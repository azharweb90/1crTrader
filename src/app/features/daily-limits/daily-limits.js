...
(function () {
  ...
  // see tierRulesMatrix's definition in app-shell.js for the current
  // numbers and the comment there for how lots/loss/growth interact.
  // tierRulesMatrix itself now lives in app-shell.js (window.tierRulesMatrix)
  ...
  // app-shell.js (always loaded), exposed as window.applyReferenceSectionState
  ...
  // `today` — matches the logic in app-shell.js used to generate mock data.
  ...
  // called here. renderInstrumentSlTable() (app-shell.js) already calls it
